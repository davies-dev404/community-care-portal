...
const Index = () => {
  const features = [
    {
      ...
      desc: "World-class healthcare services provided by top specialists in their fields.",
      image: teamImg,
      link: "/about"
    },
    {
      title: "Advanced Technology",
      desc: "State-of-the-art facilities and cutting-edge medical equipment for precise diagnosis.",
      image: "https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=2080",
      link: "/specialties"
    },
    {
      title: "Patient Care",
      desc: "Compassionate, personalized care tailored to meet the unique needs of every patient.",
  ...
  const insurancePartners = [
    ...
    { name: "Madhuper Investment", logo: null },
  ...
  const testimonials = [
    {
      text: "I am proud to be part of a transformative project that is steadily taking shape. The hospital is designed to deliver advanced specialized healthcare services to the people of Busia County.",
      role: "Local Resident"
    },
    {
      text: "I am proud to witness the steady progress of this transformative healthcare project. The development aims to provide modern facilities.",
      role: "Community Leader"
    },
    {
      text: "I am truly impressed by the progress and vision behind the construction of Hope Specialist Hospitals. This project represents hope for many families.",
      role: "Patient"
    }
  ];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card hover:shadow-healthcare-lg transition-all duration-300 p-8 rounded-2xl border border-border/50 group flex flex-col items-start text-left">
              ...
              <p className="text-muted-foreground mb-6 line-clamp-3">
                At HOPE Hospital, our Surgery Department provides comprehensive and specialized surgical care
              </p>
            ...
            <div className="bg-card hover:shadow-healthcare-lg transition-all duration-300 p-8 rounded-2xl border border-border/50 group flex flex-col items-start text-left">
              ...
              <p className="text-muted-foreground mb-6 line-clamp-3">
                HOPE’s Oncology is a full-fledged oncology care centre, committed to
              </p>
              <div className="mt-auto">
            ...
            <div className="bg-card hover:shadow-healthcare-lg transition-all duration-300 p-8 rounded-2xl border border-border/50 group flex flex-col items-start text-left">
              ...
              <p className="text-muted-foreground mb-6 line-clamp-3">
                HOPE has invested heavily in developing regions’ most competent critical care areas
              </p>
              <div className="mt-auto">
            ...
            <div className="bg-card hover:shadow-healthcare-lg transition-all duration-300 p-8 rounded-2xl border border-border/50 group flex flex-col items-start text-left">
              ...
              <p className="text-muted-foreground mb-6 line-clamp-3">
                Our Accident & Emergency (A&E) Department is a critical component of HOPE Hospital
              </p>
              <div className="mt-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-left">
              {testimonials.map((story, i) => (
                 <div key={i} className="bg-[#2e2a85]/50 p-8 rounded-xl border border-white/10 hover:border-cyan-400/50 transition-colors duration-300">
                    ...
                    <p className="font-bold text-cyan-400">— {story.role}</p>
                 </div>
              ))}
            </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-serif font-bold mb-6">
                Tour Hope Specialist Hospitals- HSH
              </h2>
            ...
            <div className="relative aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                ...
                <div className="absolute inset-0 bg-black">
                   ...
                   <div className="absolute inset-0 overflow-hidden">
                      <div className="absolute inset-0 bg-[linear-gradient(transparent_0%,rgba(20,184,166,0.1)_50%,transparent_100%)] animate-scan-slow pointer-events-none"></div>
                      <div className="absolute w-full h-[2px] bg-teal-400/50 shadow-[0_0_15px_rgba(20,184,166,0.8)] animate-scan pointer-events-none"></div>
                   </div>

                   {/* HUD Elements */}
                   <div className="absolute top-4 left-4 font-mono text-xs text-teal-400/80">
                      <div>SYSTEM: ONLINE</div>
                      <div>TARGET: MEDICAL_FACILITY</div>
                      <div className="animate-pulse">ANALYZING...</div>
                   </div>
                   <div className="absolute bottom-4 right-4 font-mono text-xs text-teal-400/80 text-right">
                      <div>AI_DIAGNOSTICS</div>
                      <div>V.2.0.4</div>
                   </div>
                   
                   {/* Corners */}
                   <div className="absolute top-4 right-4 w-8 h-8 border-t-2 border-r-2 border-teal-500/50"></div>
                   <div className="absolute bottom-4 left-4 w-8 h-8 border-b-2 border-l-2 border-teal-500/50"></div>
                </div>
            </div>
          </div>
        </div>
        ...
        <div className="healthcare-container">
           <div className="grid lg:grid-cols-2 gap-16">
              <div>
                 ...
                 <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Frequently Asked Questions - Hope Specialist Hospitals (HSH)</h2>
                 <p className="text-white/60 mb-8 leading-relaxed">
                    Find answers to common questions about Hope Specialist Hospitals (HSH), including services, visiting hours, and insurance policies, to make your experience smooth and informed.
                 </p>
                 <Link to="/contact">
              ...
              <div>
                 <Accordion type="single" collapsible className="w-full space-y-4">
                    <AccordionItem value="item-1" className="border-none bg-[#1e293b] rounded-lg px-2 data-[state=open]:bg-teal-900/20">
                      <AccordionTrigger className="hover:no-underline px-4 py-4 text-left font-semibold text-teal-50 [&[data-state=open]]:text-teal-400">What services does Hope Specialist Hospitals provide?</AccordionTrigger>
                    ...
                    <AccordionItem value="item-2" className="border-none bg-[#1e293b] rounded-lg px-2 data-[state=open]:bg-teal-900/20">
                      <AccordionTrigger className="hover:no-underline px-4 py-4 text-left font-semibold text-teal-50 [&[data-state=open]]:text-teal-400">What are the visiting hours at HSH?</AccordionTrigger>
                      <AccordionContent className="px-4 pb-4 text-white/70">
                        Our general visiting hours are from 10 AM to 8 PM. However, specific units like ICU may have restricted hours. Please contact us for more details.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3" className="border-none bg-[#1e293b] rounded-lg px-2 data-[state=open]:bg-teal-900/20">
                      <AccordionTrigger className="hover:no-underline px-4 py-4 text-left font-semibold text-teal-50 [&[data-state=open]]:text-teal-400">Does HSH accept insurance, and which providers are covered?</AccordionTrigger>
                      <AccordionContent className="px-4 pb-4 text-white/70">
                    ...
                    <AccordionItem value="item-5" className="border-none bg-[#1e293b] rounded-lg px-2 data-[state=open]:bg-teal-900/20">
                      <AccordionTrigger className="hover:no-underline px-4 py-4 text-left font-semibold text-teal-50 [&[data-state=open]]:text-teal-400">Are there any health and wellness programs available at HSH?</AccordionTrigger>
                      <AccordionContent className="px-4 pb-4 text-white/70">
