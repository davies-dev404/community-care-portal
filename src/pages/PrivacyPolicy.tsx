  ...
  const sections = [
    {
      ...
      content: "We collect personal information including name, contact details, date of birth, and government ID. Crucially, we collect Protected Health Information (PHI) such as medical history, diagnoses, test results, and treatment plans necessary for your care."
    },
    {
      icon: ShieldCheck,
      title: "HIPAA & Data Protection",
      content: "We adhere to strict data protection standards aligned with HIPAA and the Data Protection Act. Your health information is encrypted and accessible only to authorized healthcare personnel involved in your treatment."
    },
    {
      icon: Eye,
    ...
    },
    {
      icon: Lock,
      title: "Data Security",
      content: "We employ state-of-the-art security measures including 256-bit encryption, strict access controls, and regular security audits to protect your personal and medical information from unauthorized access."
    },
    {
      icon: Server,
      title: "Third-Party Sharing",
      content: "We do not sell your personal data. We only share information with insurance providers for billing, reference laboratories for testing, or when legally required by health authorities."
    },
    {
      icon: UserCheck,
      title: "Your Rights",
    ...
    },
    {
      ...
      content: "Our website uses essential cookies to ensure functionality and analytical cookies to understand how you use our site. You can manage cookie preferences through your browser settings."
    },
    {
      icon: RefreshCw,
      title: "Updates to Policy",
      content: "We reserve the right to update this privacy policy at any time. Significant changes will be communicated via our website or direct notification. Last updated: " + new Date().toLocaleDateString()
    }
  ];
        ...
        <div className="mt-16 bg-muted/30 rounded-2xl p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
             <div className="flex items-center gap-3 text-lg font-semibold text-primary">
                ...
                <span>privacy@stelizabethspecialisthospital.org</span>
             </div>
          </div>
        </div>
      </main>
