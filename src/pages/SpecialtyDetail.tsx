...
const SpecialtyDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
        ...
        <div className="healthcare-container">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/specialties" className="text-primary hover:text-primary/80">Our Specialties</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
      ...
      <div className="healthcare-container py-12 lg:py-16">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <Link to="/contact">
                <Button size="lg" className="bg-primary hover:bg-primary/90 text-white font-semibold px-8 h-12 rounded-lg">
                  Book an Appointment
                </Button>
              </Link>
            ...
            <div 
              className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-primary mb-16"
            ...
            <div className="bg-muted/30 rounded-3xl p-8 md:p-12 mb-12">
              <div className="mb-10">
                ...
                <h2 className="text-3xl font-serif font-bold text-foreground mt-4">
                  St. Elizabeth Specialist Hospital <br /> Advantages
                </h2>
              </div>
              
              <div className="grid sm:grid-cols-2 gap-6">
                {specialty.benefits.map((benefit, index) => (
                  <div key={index} className="flex items-start gap-4 p-4 bg-background rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-card border border-border/50 rounded-2xl p-6 shadow-sm">
              <h3 className="text-xl font-serif font-bold mb-6 pb-4 border-b relative after:absolute after:bottom-0 after:left-0 after:w-16 after:h-0.5 after:bg-primary">
                Services
              </h3>
                ...
                {specialtiesData.map((spec) => (
                  <li key={spec.id}>
                    <Link 
                      ...
                      className={`flex items-center justify-between p-3 rounded-lg transition-colors duration-200 ${slug === spec.id ? 'bg-primary text-white font-medium' : 'hover:bg-muted text-muted-foreground hover:text-foreground'}`}
                    >
               ...
               <ul className="space-y-6 relative z-10">
                 ...
                 <li className="flex items-start gap-4">
                   ...
                   <div>
                     ...
                     <p className="font-semibold break-all">info@stelizabethspecialisthospital.org</p>
                   </div>
                 </li>
                 <li className="flex items-start gap-4">
                   <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
